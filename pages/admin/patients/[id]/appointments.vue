...
const headers = [
    ...
    { name: "Цена", value: "price", sortable: false, balancedText: false, custom: false },
    { name: "Дата начала", value: "startDate", sortable: false, balancedText: false, custom: false },
    { name: "Дата окончания", value: "endDate", sortable: false, balancedText: false, custom: false },
