<template>
    <div class="relative overflow-hidden">
        <site-carousel />
        <div class="container min-h-screen h-full relative py-28 md:py-0">
            <div class="flex items-center h-full md:h-screen relative">
            ...
            <div class="relative h-[140px] mt-0 lg:-translate-y-28">
                <form @submit.prevent="handleRecord" class="relative rounded-md p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end shadow-lg shadow-black/5 bg-white w-full">
