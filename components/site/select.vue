<template>
    <div>
        ...
        <div class="border rounded overflow-hidden">
            <select aria-label="select" :id="randomid" :disabled="!!props.disabled" :required="required" v-model="model" @change="emits('changed', $event)" class="text-sm py-2 px-3 w-full outline-none cursor-pointer">
